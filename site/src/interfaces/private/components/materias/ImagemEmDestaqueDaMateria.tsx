const ImagemEmDestaqueDaMateria = () => {
    return (
        <div>
            <span className="font-averta font-extrabold text-laranja text-lg uppercase italic block">Imagem em destaque</span>
            <label htmlFor="imagem_destaque" className='bg-aurora h-72 flex items-center justify-center rounded-md cursor-pointer'>
