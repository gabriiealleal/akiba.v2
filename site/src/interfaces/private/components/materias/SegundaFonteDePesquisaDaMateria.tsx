    ...
    return (
        <div className='flex flex-col gap-2'>
            ...
            <div className='flex items-center gap-4 -mt-1'>
                ...
                <input id="segunda_fonte_nome" name="segunda_fonte_nome" type='text' className='w-full rounded-md p-2 font-averta appearance-none pr-8 outline-none' />
            </div>
            <div className='flex items-center gap-7 mt-1'>
                ...
                <input id="segunda_fonte_link" name="segunda_fonte_link "type='url' className='w-full rounded-md p-2 font-averta appearance-none pr-8 outline-none' />
            </div>
        </div>
    );
}
